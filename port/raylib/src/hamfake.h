 ...
 *
 * COMMENTS: This file is modified to use C linkage (no name mangling)
 */
...
typedef struct tile_info *tile_info_ptr;
...
bool hamfake_isFakeButtonPressed(enum FAKE_BUTTONS button);
void hamfake_setFakeButtonState(enum FAKE_BUTTONS button, bool state);
