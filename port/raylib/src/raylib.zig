...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /opt/zig/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /opt/zig/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /opt/zig/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /opt/zig/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /opt/zig/lib/include/stdarg.h:27:9
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /usr/include/raylib.h:114:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // /usr/include/raylib.h:117:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // /usr/include/raylib.h:120:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // /usr/include/raylib.h:123:13
